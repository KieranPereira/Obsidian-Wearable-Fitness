...
class BiometricVisualizer3DTab(QWidget):
    ...
    Expects references to a lock and to two 3-element lists holding Euler angles (in degrees)
    for the upper arm and forearm. In our example, we use the sensor’s "angle" as the pitch,
    ...
    def initUI(self):
        ...
        # Create line objects for the upper arm and forearm
        ...
        # Set initial axes limits and view
    ...
    def update_plot(self):
        # Retrieve Euler angles safely (in degrees)
        with self.data_lock:
            # For our example, we assume the sensor's "angle" is mapped to the pitch.
            # Roll and yaw remain 0.
            upper_euler_deg = self.upper_arm_euler_ref[:]  # copy of [roll, pitch, yaw]
        ...
        # Optionally adjust the axes limits if needed
